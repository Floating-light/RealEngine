                                                    ...
                                                    ComPtr<ID3D12Resource>& uploadBuffer)
{
    ...
    ThrowIfFailed(device->CreateCommittedResource(&tempHeap, D3D12_HEAP_FLAG_NONE, &TempBufferRes, D3D12_RESOURCE_STATE_COPY_DEST,nullptr, IID_PPV_ARGS(defaultBuffer.GetAddressOf())));
    ...
    ThrowIfFailed(device->CreateCommittedResource(&ttHeap, D3D12_HEAP_FLAG_NONE, &ttBufferRes, D3D12_RESOURCE_STATE_GENERIC_READ,nullptr, IID_PPV_ARGS(uploadBuffer.GetAddressOf())));
    ...
    CD3DX12_RESOURCE_BARRIER barrier2 = CD3DX12_RESOURCE_BARRIER::Transition(defaultBuffer.Get(), D3D12_RESOURCE_STATE_COPY_DEST, D3D12_RESOURCE_STATE_INDEX_BUFFER);
